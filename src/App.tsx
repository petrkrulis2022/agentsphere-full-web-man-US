    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-indigo-900 to-purple-900">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-white">Loading AgentSphere...</h1>
        ...
        <Routes>
          <Route path="/" element={
            <>
              ...
              <Features />
              <MapVisualization />
              <AuthSection waitlistCount={waitlistCount} setWaitlistCount={setWaitlistCount} supabase={supabase} />
            </>
          } />
          <Route path="/deploy" element={<DeployObject supabase={supabase} />} />
