...
const AgentInteractionModal: React.FC<AgentInteractionModalProps> = ({
  ...
  const [paymentStep, setPaymentStep] = useState<
    "selection" | "qr-generated" | "processing" | "success"
  >("selection");
  ...
  const agentPersonalities = {
    "AI Agent": {
      greeting:
        "Hello! I'm an AI agent ready to assist you with any questions or tasks. How can I help you today?",
      color: "#4F46E5",
      responses: {
        hello:
          "Hi there! Great to meet you. I'm here to help with anything you need.",
        ...
        capabilities:
          "I have access to various tools including web search, calculations, and general knowledge. I can also help with analysis and creative tasks.",
        default:
    ...
    "Study Buddy": {
      greeting:
        "Hey there! Ready to learn something new? I'm your study companion and I'm here to make learning fun and effective!",
      color: "#10B981",
      responses: {
        ...
        study:
          "Let's create a personalized study plan! What subject are you working on and what's your timeline?",
        homework:
          "I'd love to help with your homework! Share the problem or topic and I'll guide you through it step by step.",
        default:
          "Great question! Let me break this down in a way that's easy to understand and remember.",
      },
    },
    "Local Services": {
      greeting:
        "Looking for something in the area? I know all the best local spots and can help you find exactly what you need!",
      color: "#F59E0B",
      responses: {
        hello:
          "Welcome to the neighborhood! I'm your local guide. What can I help you find?",
        ...
        directions:
          "I'd be happy to give you directions! Where are you trying to go?",
        food: "There are some great dining options nearby! Are you looking for a specific type of cuisine or price range?",
        default:
          "I know this area well! Let me share some helpful local information about that.",
      },
    },
    "Content Creator": {
      greeting:
        "Let's create something amazing together! I help with writing, brainstorming, and bringing creative ideas to life.",
      color: "#EC4899",
      responses: {
        ...
        write:
          "I love helping with writing! What type of content are you working on? Blog post, story, script, or something else?",
        ideas:
          "Brainstorming time! Tell me about your project and I'll help generate some creative ideas.",
        default:
          "That sparks my creativity! Let me help you explore that idea and develop it further.",
      },
    },
    "Game Agent": {
      greeting:
      ...
      responses: {
        hello:
          "Hey player! Ready for some fun? What kind of game are you in the mood for?",
        ...
        puzzle:
          "I love puzzles! Here's a quick one: I'm thinking of a number between 1 and 100. Can you guess it in 7 tries or less?",
        default:
          "That sounds like it could be turned into a fun game or challenge! Let me think of how we can make it interactive.",
      },
    },
  };
  ...
  const getAgentPersonality = () => {
    return (
      agentPersonalities[
        agent?.object_type as keyof typeof agentPersonalities
      ] || agentPersonalities["AI Agent"]
    );
  };

  const getInteractionFee = (type: string) => {
    // Return the exact fee set by the agent owner - no multipliers
    // All interaction types (chat, voice, video) use the same base fee
    return agent?.interaction_fee || 10;
  };
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between text-sm text-gray-600">
                    ...
                    <span className="font-mono">
                      {agent.agent_wallet_address || "Not configured"}
                    </span>
                  </div>
                </div>
              </div>
            ...
            {(currentView === "voice" || currentView === "video") && (
              <div className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">
                  {currentView === "voice" ? "Voice Chat" : "Video Call"} Coming
                  Soon!
                </h3>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 mb-6">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <div className="flex items-center text-green-600 font-semibold">
                          <DollarSign size={16} />
                          <span>
                            {getInteractionFee(selectedInteractionType)} BDAG
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center text-sm mt-1">
                        ...
                        <span className="text-gray-700 text-xs">
                          BlockDAG Primordial Testnet (1043)
                        </span>
                      </div>
                      <div className="flex justify-between items-center text-sm mt-1">
                      ...
                      <div className="mt-2 p-2 bg-blue-50 rounded text-xs text-blue-800">
                        💡 <strong>Note:</strong> MetaMask will use your
                        currently active account as sender. Make sure your
                        active account has BDAG tokens.
                      </div>
                    </div>
                        ...
                        <div className="flex items-center justify-center space-x-3">
                          ...
                          <div className="text-left">
                            ...
                            <div className="text-sm opacity-90">
                              Uses your active MetaMask account
                            </div>
                          </div>
                        </div>
                      </motion.button>
  ...
  const generateLargeQRCode = async () => {
    ...
    try {
      ...
      try {
        ...
        const fallbackData = `ethereum:${tokenContract}@1043/transfer?address=${
          paymentData.merchantAddress
        }&uint256=${(paymentData.amount * Math.pow(10, 18)).toString()}`;
  ...
  return (
    <div className="ar-qr-modal-content">
      ...
      <div className="instructions">
        <p>
          🦊 <strong>MetaMask Instructions:</strong> Open MetaMask mobile app →
          Tap "Send" → Tap camera icon → Scan this QR code. The BDAG token
          transfer will auto-populate for {paymentData.amount} BDAG tokens on
          BlockDAG Primordial Testnet (Chain ID: 1043).
        </p>
        <p>
          <strong>⚠️ Important:</strong> Make sure MetaMask is connected to
          BlockDAG Primordial Testnet and the BDAG token
          (0x6533fe2Ebb66CcE28FDdBA9663Fe433A308137e9) is added to your wallet.
        </p>
      </div>
      ...
      <div className="ar-note">
        <small>
          💡 <strong>Strict EIP-681 BDAG Transfer:</strong>{" "}
          ethereum:0x6533fe2Ebb66CcE28FDdBA9663Fe433A308137e9@1043/transfer?address=
          {connectedAddress || paymentData.merchantAddress}&uint256=
          {(paymentData.amount * Math.pow(10, 18)).toString()}
        </small>
      </div>
    </div>
  );
