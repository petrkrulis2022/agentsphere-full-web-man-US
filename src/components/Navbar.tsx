            ...
            <div className="hidden md:flex items-center space-x-4">
              {location.pathname === '/' ? (
                <>
                  ...
                  <a href="#map" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">
                    Explore
                  </a>
                  <a href="#auth" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">
                    Join Waitlist
                  </a>
                </>
              ) : (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-gray-700">
                            <strong>Get your credentials:</strong> In your Supabase dashboard, go to Settings → API to find your Project URL and anon public key.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <div className="mt-2 bg-gray-900 text-green-400 p-3 rounded-lg text-sm font-mono">
                            ...
                            <div>VITE_THIRDWEB_CLIENT_ID=299516306b51bd6356fd8995ed628950</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="text-gray-700">
                            <strong>Restart the development server:</strong> Stop your dev server and run <code className="bg-gray-100 px-1 rounded">npm run dev</code> again.
                          </p>
                        </div>
                      </div>
                    </div>
