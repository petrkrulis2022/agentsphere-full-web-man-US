  ...
  const features = [
    {
      ...
      description: "Use your phone to scan real locations and deploy personalized AI agents in under 30 seconds",
    ...
    },
    {
      ...
      description: "See and talk to AI agents through augmented reality on your mobile device with 99.7% accuracy",
    ...
    },
    {
      ...
      title: "AR QR Pay",
      description: "Revolutionary AR QR payment system powered by blockchain technology for instant secure transactions",
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {agentTypes.map((agent, index) => (
              ...
              >
                ...
                <div>
                  <span className="font-medium text-gray-800 block">{agent.name}</span>
                  <span className="text-xs text-green-600 font-semibold">{agent.users} active users</span>
                </div>
              </div>
            ))}
          </div>
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-green-100/50 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Join 2,847+ innovators already building with AgentSphere. Your first agent deployment is free.
            </p>
